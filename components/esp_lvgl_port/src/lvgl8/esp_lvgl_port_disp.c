...
#define CONFIG_IDF_LCD_RGB 1
#define CONFIG_IDF_LCD_MIPI 0

#if CONFIG_IDF_LCD_RGB && ESP_IDF_VERSION >= ESP_IDF_VERSION_VAL(5, 0, 0)
#include "esp_lcd_panel_rgb.h"
#endif

#if (CONFIG_IDF_LCD_MIPI && ESP_IDF_VERSION >= ESP_IDF_VERSION_VAL(5, 3, 0))
...
#elif CONFIG_IDF_LCD_MIPI && ESP_IDF_VERSION >= ESP_IDF_VERSION_VAL(5, 3, 0)
        buffer_size = disp_cfg->hres * disp_cfg->vres;
