...
void ui_ScreenCameraShot_screen_init(void)
{
    ...
    lv_obj_set_style_pad_all(ui_ScreenCameraShot, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_size(ui_ImageCameraShotImage, LV_PCT(100), LV_PCT(100));
    ...
    lv_obj_align(ui_PanelCameraShotControlBg, LV_ALIGN_BOTTOM_RIGHT, -10, -10);
    ...
    ui_ButtonCameraShotBtn = lv_btn_create(ui_PanelCameraShotControlBg);
    lv_obj_set_width(ui_ButtonCameraShotBtn, 50);
    lv_obj_set_height(ui_ButtonCameraShotBtn, 50);
    lv_obj_center(ui_ButtonCameraShotBtn);
    ...
    lv_obj_set_size(ui_PanelCameraShotAlbum, 80, 80);
    lv_obj_align(ui_PanelCameraShotAlbum, LV_ALIGN_BOTTOM_LEFT, 5, -10);
    ...
    lv_obj_set_style_bg_color(ui_PanelCameraShotAlbum, lv_color_hex(0xFF00FF), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_all(ui_PanelCameraShotAlbum, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
