...
bool Camera::run(void)
{
    if (_camera_init_sem == NULL) {
        ...
        xTaskCreatePinnedToCore((TaskFunction_t)taskCameraInit, "Camera Init", 4096, this, 2, NULL, 1);
    ...
    lv_obj_align(mode_switch_btn, LV_ALIGN_TOP_MID, 0, 0);
...
bool Camera::init(void)
{
    ...
    if (ret != ESP_OK) {
        ...
        if (ESP_OK == i2c_master_probe(i2c_bus_handle, 0x5a, 100) ) {
